...
golem::fill_desc(
  ...
  repo_url = "https://github.com/MatthiasUckert/RsClassification.git" # The URL of the GitHub Repo (optional) 
)     
...
usethis::use_mit_license(copyright_holder = "Matthias Uckert")  # You can set another license here
